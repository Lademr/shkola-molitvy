...
const authors: Author[] = [
  {
    id: 'pliev-vladimir',
    name: 'Плиев В.Б.',
    title: 'Пресвитер Владикавказской Церкви "Духовное Возрождение" ЕХБ',
    bio: 'Владимир Бексултанович несет служение во Владикавказской Церкви "Духовное Возрождение" ЕХБ более 20 лет. Имеет глубокий опыт духовного наставничества и преподавания библейских дисциплин. Специализируется на учении о молитвенной жизни и духовном росте.',
    credentials: [
      'Пресвитер церкви ЕХБ',
      'Более 20 лет духовного наставничества',
      'Выпускник богословских курсов МСЦ ЕХБ',
      'Сертифицированный преподаватель библейских дисциплин'
    ],
    experience: 'Более 20 лет духовного наставничества. Провел сотни библейских исследований по молитвенной жизни.',
    publications: [
      ...
      <div className="mt-8 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="border-l-4 border-amber-500 pl-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Материалы соответствуют учению Российского Союза ЕХБ
            </p>
          </div>
        </div>
      </div>
